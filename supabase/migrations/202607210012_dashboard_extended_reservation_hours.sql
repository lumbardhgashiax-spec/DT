-- Dashboard reservations: allow staff to reserve from 10:00 through 00:00
-- and remove the former five-hour duration limit. No tables are changed.
...
begin
  ...
  if p_duration_minutes < 60 or mod(p_duration_minutes, 30) <> 0 then
    raise exception 'Kohezgjatja duhet te jete te pakten 1 ore, me intervale prej 30 minutash.' using errcode = '22023';
  end if;
